-- Requeues credit-note claims left processing by interrupted workers.
create or replace function requeue_stale_event_purchase_credit_note_claims()
returns int as $$
declare
    v_count int;
begin
    ...
    set
        ...
        failure_message = case
            ...
            -- Preserve or initialize retryable failure context below the limit
                ...
                failure_message,
                'Credit-note worker claim expired'
            )
        end,
